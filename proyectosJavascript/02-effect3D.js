...
function main() {
	...
	mouse = new THREE.Vector2(1.0,0.4);
...
function loadPrincipalImage() {
	...
	//fragColor = vec4(iMouse.y,0.0,0.0, 1.0);
...
// 	uniforms.iMouse.x = 0.0;
// 	uniforms.iMouse.y = 0.0;
	//uniforms.mouse.x = 0.0;
// 	uniforms.mouse = new THREE.Vector2(
// 	            parseFloat(mouse.x) * 1.0,
// 	            parseFloat(mouse.y));
// 	uniforms.mouse = new THREE.Vector2(
// 	    parseFloat(mouse.x),
// 	    parseFloat(mouse.y)       
